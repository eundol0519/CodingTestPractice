function findTheLongestSubstringThatEndsWithASpecificString(
  myString: string,
  pat: string
): string {
  let answer: string = "";

  const last: number = myString.lastIndexOf(pat);
...
findTheLongestSubstringThatEndsWithASpecificString("AbCdEFG", "dE");
findTheLongestSubstringThatEndsWithASpecificString("AAAAaaaa", "a");
